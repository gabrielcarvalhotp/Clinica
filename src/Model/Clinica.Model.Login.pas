...
uses
  ...
  Clinica.Controller.Login, System.Types, Vcl.Graphics;
...
begin
  ...
  begin
    aValue.SetFocus;
    Application.MessageBox(PWideChar('Informe o campo Nome!'), 'Atenção', MB_Ok + MB_ICONWARNING);
    Abort;
  end
end;
...
begin
  ...
  begin  
    aValue.SetFocus;
    Application.MessageBox(PWideChar('Informe o campo Senha'), 'Atenção', MB_Ok + MB_ICONWARNING);
    Abort;
  end
end;
