...
function TModelEntidadesPacientes.Grid: iModelEntidadesInterfacesPacientes;
begin
  FDataSet
    .Close
    .Clear
...
function TModelEntidadesPacientes.todos: iModelEntidadesInterfacesPacientes;
var
  id : string;
begin
  ...
  FDataSet
    .Close
    .Clear
    .Sql(' SELECT * FROM PACIENTES WHERE PACIENTES.ID = ' + id)
    .Active;
end;
