...
begin
  ...
  self
    ...
    .&End    
    .Id_Usuario(FDataSet.FieldByName('ID_USUARIO'))
    .Executar(FDataSet.FieldByName('EXECUTAR'))
    .Inserir(FDataSet.FieldByName('INSERIR'))
    .Alterar(FDataSet.FieldByName('ALTERAR'))
    .Deletar(FDataSet.FieldByName('DELETAR')) 
end;
...
begin
  ...
  FDataSet
    ...
    .Sql(' SELECT ' + 
         ...
         ' AND ' +
         '   USUARIOS_PERMICOES.NOME = ' + QuotedStr(aName))
    .Active
end;
